                ...
                <div className="second-col colm">
                    ...
                    <div className="social-icons">
                        <a href="#" className="icon">
                            <img src="/images/social-icon-img/twitter.svg" alt="" />
                        </a>
                        <a href="#" className="icon" id='fb'>
                            <img src="/images/social-icon-img/facebook-f.svg" alt="" />
                        </a>
                        <a href="#" className="icon">
                            <img src="/images/social-icon-img/youtube.svg" alt="" />
                        </a>
                        <a href="#" className="icon">
                            <img src="/images/social-icon-img/instagram.svg" alt="" />
                        </a>
                        <a href="#" className="icon">
                            <img src="/images/social-icon-img/google-plus-g.svg" alt="" />
                        </a>
                        <a href="#" className="icon">
                            <img src="/images/social-icon-img/github.svg" alt="" />
                        </a>
                    </div>
                </div>
